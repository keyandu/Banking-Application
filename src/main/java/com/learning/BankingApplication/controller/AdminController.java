...
public class AdminController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody CreateStaffRequest createStaffRequest) {
        ...
        User user = new User(createStaffRequest.getStaffUserName(),
                createStaffRequest.getStaffFullName(),
    ...
    public ResponseEntity<List<CustomerInformation>> EnableOrDisableStaff(ChangeStaffStatusRequest changeStaffStatusRequest) {
