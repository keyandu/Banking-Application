...
public class BeneficiaryController {
	...
	@PostMapping("/customer/{id}/delete_beneficiary")
	public String deleteBene(@Valid @PathVariable long userid, @RequestBody BeneficiaryRequest beneReq) {
		return beneServ.deleteBeneficiary(userid, beneReq);
	}
